...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSNivelENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSNivelENDCLASS_t qt_meta_stringdata_CLASSNivelENDCLASS = {
    {
        QT_MOC_LITERAL(0, 5)   // "Nivel"
    },
    "Nivel"
};
