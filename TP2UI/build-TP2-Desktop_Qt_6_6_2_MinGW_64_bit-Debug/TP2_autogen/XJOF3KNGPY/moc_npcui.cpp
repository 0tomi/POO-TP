...
Q_CONSTINIT static const qt_meta_stringdata_CLASSNPCUIENDCLASS_t qt_meta_stringdata_CLASSNPCUIENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 23),  // "animacionSalirTerminada"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 24)   // "animacionEntrarTerminada"
    },
    "NPCUI",
    "animacionSalirTerminada",
    "",
...
Q_CONSTINIT const QMetaObject NPCUI::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNPCUIENDCLASS_t,
        ...
        // method 'animacionSalirTerminada'
...
void NPCUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NPCUI *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->animacionSalirTerminada(); break;
        case 1: _t->animacionEntrarTerminada(); break;
        default: ;
        }
        ...
        {
            using _t = void (NPCUI::*)();
            if (_t _q_method = &NPCUI::animacionSalirTerminada; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (NPCUI::*)();
            if (_t _q_method = &NPCUI::animacionEntrarTerminada; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void NPCUI::animacionSalirTerminada()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void NPCUI::animacionEntrarTerminada()
{
